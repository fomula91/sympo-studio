  ...
  return (
    <div style={{ padding: '24px 24px 80px', maxWidth: 1200 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16, flexWrap: 'wrap' }}>
        <Badge
          tone="warning"
          style={{ fontFamily: MONO, fontSize: 10, fontWeight: 700, letterSpacing: '0.08em', padding: '5px 9px' }}
        >
          샘플 데이터
        </Badge>
        ...
        {METRICS.map((m) => {
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 12 }}>
              ...
              {/* height:'auto'·fontWeight:700은 교체 전 인라인 값이다 — Badge 기본값(22px·650)을
                  그대로 두면 이 배지만 3px 커지고 글자가 얇아진다(에디터 쪽 배지들도 같은 이유로
                  height를 덮는다). */}
              <Badge tone="success" style={{ padding: '3px 8px', height: 'auto', fontWeight: 700 }}>
                {m.delta}
              </Badge>
            </div>
          </Card>
