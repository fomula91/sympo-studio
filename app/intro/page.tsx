  ...
  return (
    ...
    >
      ...
      <section style={{ maxWidth: 1120, margin: '0 auto', padding: 'clamp(40px, 8vw, 72px) 24px 40px' }}>
        <div style={{ fontFamily: MONO, fontSize: 12, letterSpacing: '0.16em', color: UI.brand, marginBottom: 18, textTransform: 'uppercase' }}>
        ...
        <p style={{ fontSize: 18, color: UI.muted, lineHeight: 1.65, maxWidth: 620, margin: '0 0 36px' }}>
        ...
        <div style={{ borderRadius: 16, overflow: 'hidden', border: `1px solid ${UI.line}`, boxShadow: '0 40px 80px -30px oklch(0 0 0 / 0.5)' }}>
