...
export default function EditEventPage() {
  ...
  const { s, ev, presets, patch, patchEvent, loadStatus, user, createPreset } = useStudio();
  ...
  return (
    <EditorScreen s={s} ev={ev} presets={presets} patch={patch} patchEvent={patchEvent} user={user} createPreset={createPreset} />
  );
}
